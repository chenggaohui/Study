...
public class DeferredResultController {
    ...
    public DeferredResultResponse get(@RequestParam(value = "timeout", required = false, defaultValue = "10000") Long timeout) {
        DeferredResult<DeferredResultResponse> deferredResult = getDeferredResultResponseDeferredResult(timeout);
        ...
        return (DeferredResultResponse)deferredResult.getResult();
    }

    private DeferredResult<DeferredResultResponse> getDeferredResultResponseDeferredResult(Long timeout) {
